...
class UnitsChasCampbellGravitationalEngineVersion3Parts(unittest.TestCase):
    # ok
...
class UnitsChasCampbellGravitationalEngineVersion3AssembliesWithMasselottes(unittest.TestCase):
    # ok
